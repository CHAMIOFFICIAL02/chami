...
global.botname = "King Chami" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "*CHAMI*"  
global.packname = "KING✯CHAMI✯𝘽𝙊𝙏"  
global.myweb = "https://github.com/PikaBotz" // You can put any link 
global.waterMark = "×͜× King ✘ CHAMI™ ✓" // Your own watermark 
global.headerText = "KING by CHAMI" // text for header of menu         
global.DocumentTitle = "MASTER⚔️CHAMI" 


global.ownername = "𝕻𝖎𝖐𝖆♰𝕶𝖚𝖓"   // Owner name //        
global.ownernumber = ['+13173484904'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : 3.69_CHAMI" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: Ytname"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "India" // your country name
global.state = "Assam" // your state name
global.district = "Ratnapura" // your district name
global.timezone = "Asia/Kolkata" // search on google if you don't know the timezone of your country //
global.instagramId = "3.69_chami" // Your insta ID
global.email = "no" // put your email here
...
name16 = "𓄂⍣⃝ chami 𓆩×͜×𓆪ꪾ️"
name17 = "*chami 𓆩×͜×𓆪ꪾ*"
name18 = "*chai 𓆩×͜×𓆪ꪾ*"

//--------Random footer message-----------\\
footer1 = `𓄂⍣⃝chamiㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ `
footer2 = `chamiㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ`
